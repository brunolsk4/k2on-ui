...
const generateData = (days: number) => {
  ...
  for (let i = days * 2; i > 0; i--) {
    ...
    const baseValue = 1 + Math.random() * 3;
    data.push({
...
export function GanhosCard() {
  ...
  return (
    <Card className="border-border hover:border-primary/50 transition-all duration-300 hover:scale-105 hover:shadow-lg animate-fade-in" style={{ animationDelay: '0.1s' }}>
      <div className="p-5">
