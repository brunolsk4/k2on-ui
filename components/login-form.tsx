...
export function LoginForm({
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    setLoading(true)
    try {
      apiClient.setRemember(!!remember)
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
        ...
        <FieldGroup>
          <div className="flex flex-col items-center gap-2 text-center">
            <Link href="/login" className="flex flex-col items-center gap-2 font-medium">
              ...
              <span className="sr-only">K2ON</span>
            </Link>
            <h1 className="text-xl font-bold">Seja bem vindo novamente</h1>
            <FieldDescription>
      ...
      <FieldDescription className="px-6 text-center">
        Clicando em continuar, você concorda com nossos <a href="https://app.k2on.com/politica-privacidade.html">Termos de Serviço</a>{" "}
        e <a href="https://app.k2on.com/politica-privacidade.html">Política de Privacidade</a>.
      </FieldDescription>
    </div>
  )
}
